...
In my assumption, I thought the total number of clusters should equal to how many mediums have appeared in the metadata which is 7. However, the graph shows the best result is when n_clusters = 11 and I decide to move on.
